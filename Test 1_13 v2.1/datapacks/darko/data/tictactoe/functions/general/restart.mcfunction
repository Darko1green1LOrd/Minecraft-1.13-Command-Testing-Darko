...
# - Udelá červený bossbar neviditelný
bossbar set minecraft:blueturn visible false
# - Udelá modrý bossbar neviditelný
bossbar set minecraft:tttswws visible true
bossbar set minecraft:tttswws players @a[tag=!nobossbaronme]
# - Udelá tttswws bossbar viditelný pro hráče co ho mají zaplý
...
bossbar set minecraft:tttswws value 5
# - Nastaví hodnotu tttswws bossbaru na 5/5
bossbar set minecraft:tttswws color yellow
# - Nastaví tttsww bossbaru žlutoub barvu