# Blue team 
# Tohle se spustí když hráč z červeného teamu klikne na ceduli Line 1
summon minecraft:falling_block 63 11 -24 {BlockState:{Name:"light_blue_concrete"},Time:1}
...
bossbar set minecraft:tttswws visible false
# - Vypne viditelnost tttswws bossbaru
